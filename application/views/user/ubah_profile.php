    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="form-group row"> <label for="nama" class="col-sm-2 col-form-label">Nama Lengkap</label>
                <div class="col-sm-10"> <input type="text" class="form-control" id="nama" name="nama" value="<?= $user['nama']; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-file"> <input type="file" class="custom-file-input" id="image" name="image">
